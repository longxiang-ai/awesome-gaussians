...
- **[BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis](https://arxiv.org/abs/2411.08508v1)**  
  ...
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2411.08508v1.pdf)  
...
- **[Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis](https://arxiv.org/abs/2411.00144v1)**  
  ...
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2411.00144v1.pdf) | [![Stars](https://img.shields.io/github/stars/sailor-z/SE-GS?style=social)](https://github.com/sailor-z/SE-GS)  
...
- **[DepthSplat: Connecting Gaussian Splatting and Depth](https://arxiv.org/abs/2410.13862v1)**  
  ...
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2410.13862v1.pdf)  
...
- **[DN-4DGS: Denoised Deformable Network with Temporal-Spatial Aggregation for Dynamic Scene Rendering](https://arxiv.org/abs/2410.13607v2)**  
  ...
  关键词: gaussian splatting, 3d gaussian, nerf  
- **[DriveDreamer4D: World Models Are Effective Data Machines for 4D Driving Scene Representation](https://arxiv.org/abs/2410.13571v2)**  
  作者: Guosheng Zhao, Chaojun Ni, Xiaofeng Wang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2410.13571v2.pdf)  
...
- **[GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information](https://arxiv.org/abs/2410.11356v1)**  
  ...
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2410.11356v1.pdf)  
...
- **[Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors](https://arxiv.org/abs/2410.09467v1)**  
  ...
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2410.09467v1.pdf)  
...
- **[6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering](https://arxiv.org/abs/2410.04974v2)**  
  ...
  关键词: gaussian splatting, 3d gaussian, real-time rendering, nerf  
- **[Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting](https://arxiv.org/abs/2410.04680v2)**  
  作者: Matthew Strong, Boshu Lei, Aiden Swann, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2410.04680v2.pdf)  
...
- **[3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields](https://arxiv.org/abs/2409.13222v1)**  
  作者: Youngdong Jang, Hyunje Park, Feng Yang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2409.13222v1.pdf)  
  摘要: Recently, 3D Gaussian splatting has been getting a lot of attention as an innovative method for representing 3D space due to rapid rendering and image quality. However, copyright protection for the 3D...  
  关键词: gaussian splatting, 3d gaussian  
...
- **[FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering](https://arxiv.org/abs/2408.12894v1)**  
  ...
  关键词: gaussian splatting, 3d gaussian, real-time rendering  
- **[GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion](https://arxiv.org/abs/2408.12677v2)**  
  作者: Jiaxin Wei, Stefan Leutenegger  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2408.12677v2.pdf) | [![Stars](https://img.shields.io/github/stars/goldoak/GSFusion?style=social)](https://github.com/goldoak/GSFusion)  
...
- **[Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation](https://arxiv.org/abs/2408.10041v2)**  
  ...
  关键词: gaussian splatting  
- **[SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting](https://arxiv.org/abs/2408.09665v1)**  
  作者: Haoyu Zhao, Chen Yang, Hao Wang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2408.09665v1.pdf)  
  摘要: Reconstructing photo-realistic animatable human avatars from monocular videos remains challenging in computer vision and graphics. Recently, methods using 3D Gaussians to represent the human body have...  
  关键词: 3d gaussian, real-time rendering  
- **[CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning](https://arxiv.org/abs/2408.09663v2)**  
  作者: Haoyu Zhao, Hao Wang, Chen Yang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2408.09663v2.pdf)  
  摘要: Recent advancements in human avatar synthesis have utilized radiance fields to reconstruct photo-realistic animatable human avatars. However, both NeRFs-based and 3DGS-based methods struggle with main...  
  关键词: nerf  
...
- **[GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting](https://arxiv.org/abs/2407.01301v1)**  
  ...
  关键词: gaussian splatting, neural rendering  
- **[Fast and Efficient: Mask Neural Fields for 3D Scene Segmentation](https://arxiv.org/abs/2407.01220v1)**  
  作者: Zihan Gao, Lingling Li, Licheng Jiao, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2407.01220v1.pdf)  
...
- **[Trim 3D Gaussian Splatting for Accurate Geometry Representation](https://arxiv.org/abs/2406.07499v1)**  
  ...
  关键词: gaussian splatting, 3d gaussian  
- **[Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field](https://arxiv.org/abs/2406.07329v3)**  
...
- **[Gaussian Primitives for Deformable Image Registration](https://arxiv.org/abs/2406.03394v2)**  
  ...
  关键词: gaussian splatting, 3d gaussian  
- **[Dynamic 3D Gaussian Fields for Urban Areas](https://arxiv.org/abs/2406.03175v1)**  
  作者: Tobias Fischer, Jonas Kulhanek, Samuel Rota Bulò, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2406.03175v1.pdf)  
...
- **[Event3DGS: Event-Based 3D Gaussian Splatting for High-Speed Robot Egomotion](https://arxiv.org/abs/2406.02972v4)**  
  ...
  关键词: gaussian splatting, 3d gaussian, 3d reconstruction  
- **[Adversarial Generation of Hierarchical Gaussians for 3D Generative Model](https://arxiv.org/abs/2406.02968v1)**  
  作者: Sangeek Hyun, Jae-Pil Heo  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2406.02968v1.pdf)  
...
- **[FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping](https://arxiv.org/abs/2406.01916v3)**  
  ...
  关键词: gaussian splatting, 3d gaussian  
- **[Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting](https://arxiv.org/abs/2406.01593v1)**  
  作者: Shaojie Ma, Yawei Luo, Yi Yang  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2406.01593v1.pdf)  
  摘要: 3D reconstruction and simulation, while interrelated, have distinct objectives: reconstruction demands a flexible 3D representation adaptable to diverse scenes, whereas simulation requires a structure...  
  关键词: gaussian splatting, 3d gaussian, 3d reconstruction, nerf  
...
- **[Object-centric Reconstruction and Tracking of Dynamic Unknown Objects using 3D Gaussian Splatting](https://arxiv.org/abs/2405.20104v2)**  
  ...
  关键词: gaussian splatting, 3d gaussian, 3d reconstruction  
- **[PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting](https://arxiv.org/abs/2405.19957v3)**  
  作者: Qiaowei Miao, Yawei Luo, Yi Yang  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2405.19957v3.pdf)  
  摘要: As text-conditioned diffusion models (DMs) achieve breakthroughs in image, video, and 3D generation, the research community's focus has shifted to the more challenging task of text-to-4D synthesis, wh...  
  关键词: gaussian splatting  
...
- **[LP-3DGS: Learning to Prune 3D Gaussian Splatting](https://arxiv.org/abs/2405.18784v1)**  
  ...
  关键词: gaussian splatting, 3d gaussian  
- **[EvaGaussians: Event Stream Assisted Gaussian Splatting from Blurry Images](https://arxiv.org/abs/2405.20224v1)**  
  作者: Wangbo Yu, Chaoran Feng, Jiye Tang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2405.20224v1.pdf)  
...
- **[Mani-GS: Gaussian Splatting Manipulation with Triangular Mesh](https://arxiv.org/abs/2405.17811v1)**  
  ...
  关键词: gaussian splatting, 3d gaussian, nerf  
- **[SafeguardGS: 3D Gaussian Primitive Pruning While Avoiding Catastrophic Scene Destruction](https://arxiv.org/abs/2405.17793v1)**  
  作者: Yongjae Lee, Zhaoliang Zhang, Deliang Fan  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2405.17793v1.pdf)  
  摘要: 3D Gaussian Splatting (3DGS) has made a significant stride in novel view synthesis, demonstrating top-notch rendering quality while achieving real-time rendering speed. However, the excessively large ...  
  关键词: gaussian splatting, 3d gaussian, real-time rendering  
...
- **[GaussianFormer: Scene as Gaussians for Vision-Based 3D Semantic Occupancy Prediction](https://arxiv.org/abs/2405.17429v1)**  
  ...
  关键词: 3d gaussian  
- **[MoSca: Dynamic Gaussian Fusion from Casual Videos via 4D Motion Scaffolds](https://arxiv.org/abs/2405.17421v1)**  
  作者: Jiahui Lei, Yijia Weng, Adam Harley, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2405.17421v1.pdf)  
  摘要: We introduce 4D Motion Scaffolds (MoSca), a neural information processing system designed to reconstruct and synthesize novel views of dynamic scenes from monocular videos captured casually in the wil...  
  关键词: gaussian splatting  
...
- **[LDM: Large Tensorial SDF Model for Textured Mesh Generation](https://arxiv.org/abs/2405.14580v3)**  
  ...
  关键词: 3d gaussian, nerf  
- **[MagicDrive3D: Controllable 3D Generation for Any-View Rendering in Street Scenes](https://arxiv.org/abs/2405.14475v2)**  
  作者: Ruiyuan Gao, Kai Chen, Zhihao Li, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2405.14475v2.pdf)  
...
- **[MeGA: Hybrid Mesh-Gaussian Head Avatar for High-Fidelity Rendering and Head Editing](https://arxiv.org/abs/2404.19026v1)**  
  ...
  关键词: gaussian splatting, 3d gaussian, neural rendering  
- **[DGE: Direct Gaussian 3D Editing by Consistent Multi-view Editing](https://arxiv.org/abs/2404.18929v2)**  
  作者: Minghao Chen, Iro Laina, Andrea Vedaldi  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2404.18929v2.pdf)  
...
- **[3D Gaussian Splatting with Deferred Reflection](https://arxiv.org/abs/2404.18454v2)**  
  ...
  关键词: gaussian splatting  
- **[Reconstructing Satellites in 3D from Amateur Telescope Images](https://arxiv.org/abs/2404.18394v1)**  
  作者: Zhiming Chang, Boyang Liu, Yifei Xia, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2404.18394v1.pdf)  
...
- **[Reinforcement Learning with Generalizable Gaussian Splatting](https://arxiv.org/abs/2404.07950v3)**  
  ...
  关键词: gaussian splatting, 3d gaussian  
- **[View-Consistent 3D Editing with Gaussian Splatting](https://arxiv.org/abs/2403.11868v8)**  
  作者: Yuxuan Wang, Xuanyu Yi, Zike Wu, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2403.11868v8.pdf)  
...
- **[GeoGaussian: Geometry-aware Gaussian Splatting for Scene Rendering](https://arxiv.org/abs/2403.11324v2)**  
  ...
  关键词: gaussian splatting, 3d gaussian  
- **[BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis](https://arxiv.org/abs/2403.11273v1)**  
  作者: Lutao Jiang, Lin Wang  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2403.11273v1.pdf)  
  摘要: Text-to-3D synthesis has recently seen intriguing advances by combining the text-to-image models with 3D representation methods, e.g., Gaussian Splatting (GS), via Score Distillation Sampling (SDS). H...  
  关键词: gaussian splatting, 3d gaussian  
...
- **[4D-Rotor Gaussian Splatting: Towards Efficient Novel View Synthesis for Dynamic Scenes](https://arxiv.org/abs/2402.03307v3)**  
  ...
  关键词: gaussian splatting, 3d gaussian  
- **[SGS-SLAM: Semantic Gaussian Splatting For Neural Dense SLAM](https://arxiv.org/abs/2402.03246v5)**  
  作者: Mingrui Li, Shuhong Liu, Heng Zhou, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2402.03246v5.pdf)  
  ...
  关键词: gaussian splatting, real-time rendering  
- **[GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting](https://arxiv.org/abs/2402.01459v3)**  
  作者: Joanna Waczyńska, Piotr Borycki, Sławomir Tadeja, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2402.01459v3.pdf)  
  摘要: Recently, a range of neural network-based methods for image rendering have been introduced. One such widely-researched neural radiance field (NeRF) relies on a neural network to represent 3D scenes, a...  
  关键词: gaussian splatting, real-time rendering, nerf  
...
- **[HeadGaS: Real-Time Animatable Head Avatars via 3D Gaussian Splatting](https://arxiv.org/abs/2312.02902v2)**  
  ...
  关键词: 3d gaussian, real-time rendering  
- **[Gaussian Head Avatar: Ultra High-fidelity Head Avatar via Dynamic Gaussians](https://arxiv.org/abs/2312.03029v2)**  
  作者: Yuelang Xu, Benwang Chen, Zhe Li, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2312.03029v2.pdf)  
  摘要: Creating high-fidelity 3D head avatars has always been a research hotspot, but there remains a great challenge under lightweight sparse view setups. In this paper, we propose Gaussian Head Avatar repr...  
  关键词: 3d gaussian  
...
- **[SuGaR: Surface-Aligned Gaussian Splatting for Efficient 3D Mesh Reconstruction and High-Quality Mesh Rendering](https://arxiv.org/abs/2311.12775v3)**  
  作者: Antoine Guédon, Vincent Lepetit  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2311.12775v3.pdf)  
  摘要: We propose a method to allow precise and extremely fast mesh extraction from 3D Gaussian Splatting. Gaussian Splatting has recently become very popular as it yields realistic rendering while being sig...  
  关键词: gaussian splatting, 3d gaussian, nerf  
- **[A Compact Dynamic 3D Gaussian Representation for Real-Time Dynamic View Synthesis](https://arxiv.org/abs/2311.12897v2)**  
  作者: Kai Katsumata, Duc Minh Vo, Hideki Nakayama  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2311.12897v2.pdf)  
  摘要: 3D Gaussian Splatting (3DGS) has shown remarkable success in synthesizing novel views given multiple views of a static scene. Yet, 3DGS faces challenges when applied to dynamic scenes because 3D Gauss...  
  关键词: gaussian splatting, 3d gaussian  
- **[PhysGaussian: Physics-Integrated 3D Gaussians for Generative Dynamics](https://arxiv.org/abs/2311.12198v3)**  
  作者: Tianyi Xie, Zeshun Zong, Yuxing Qiu, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2311.12198v3.pdf)  
  摘要: We introduce PhysGaussian, a new method that seamlessly integrates physically grounded Newtonian dynamics within 3D Gaussians to achieve high-quality novel motion synthesis. Employing a custom Materia...  
  关键词: 3d gaussian  
- **[GS-SLAM: Dense Visual SLAM with 3D Gaussian Splatting](https://arxiv.org/abs/2311.11700v4)**  
  作者: Chi Yan, Delin Qu, Dan Xu, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2311.11700v4.pdf)  
  摘要: In this paper, we introduce \textbf{GS-SLAM} that first utilizes 3D Gaussian representation in the Simultaneous Localization and Mapping (SLAM) system. It facilitates a better balance between efficien...  
  关键词: 3d gaussian  
- **[LucidDreamer: Towards High-Fidelity Text-to-3D Generation via Interval Score Matching](https://arxiv.org/abs/2311.11284v3)**  
  作者: Yixun Liang, Xin Yang, Jiantao Lin, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2311.11284v3.pdf)  
  摘要: The recent advancements in text-to-3D generation mark a significant milestone in generative models, unlocking new possibilities for creating imaginative 3D assets across various real-world scenarios. ...  
  关键词: gaussian splatting, 3d gaussian  
- **[GaussianDiffusion: 3D Gaussian Splatting for Denoising Diffusion Probabilistic Models with Structured Noise](https://arxiv.org/abs/2311.11221v1)**  
  作者: Xinhai Li, Huaibin Wang, Kuo-Kun Tseng  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2311.11221v1.pdf)  
  摘要: Text-to-3D, known for its efficient generation methods and expansive creative potential, has garnered significant attention in the AIGC domain. However, the amalgamation of Nerf and 2D diffusion model...  
  关键词: gaussian splatting, 3d gaussian, 3d reconstruction, nerf  
- **[SplatArmor: Articulated Gaussian splatting for animatable humans from monocular RGB videos](https://arxiv.org/abs/2311.10812v1)**  
  作者: Rohit Jena, Ganesh Subramanian Iyer, Siddharth Choudhary, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2311.10812v1.pdf)  
  摘要: We propose SplatArmor, a novel approach for recovering detailed and animatable human models by `armoring' a parameterized body model with 3D Gaussians. Our approach represents the human as a set of 3D...  
  关键词: gaussian splatting, 3d gaussian, neural rendering  
- **[Compressed 3D Gaussian Splatting for Accelerated Novel View Synthesis](https://arxiv.org/abs/2401.02436v2)**  
  作者: Simon Niedermayr, Josef Stumpfegger, Rüdiger Westermann  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2401.02436v2.pdf)  
  摘要: Recently, high-fidelity scene reconstruction with an optimized 3D Gaussian splat representation has been introduced for novel view synthesis from sparse image sets. Making such representations suitabl...  
  关键词: 3d gaussian  
- **[Drivable 3D Gaussian Avatars](https://arxiv.org/abs/2311.08581v1)**  
  作者: Wojciech Zielonka, Timur Bagautdinov, Shunsuke Saito, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2311.08581v1.pdf)  
  摘要: We present Drivable 3D Gaussian Avatars (D3GA), the first 3D controllable model for human bodies rendered with Gaussian splats. Current photorealistic drivable avatars require either accurate 3D regis...  
  关键词: gaussian splatting, 3d gaussian  

### 2023年10月
- **[Dynamic Gaussian Splatting from Markerless Motion Capture can Reconstruct Infants Movements](https://arxiv.org/abs/2310.19441v1)**  
  作者: R. James Cotton, Colleen Peyton  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2310.19441v1.pdf)  
  摘要: Easy access to precise 3D tracking of movement could benefit many aspects of rehabilitation. A challenge to achieving this goal is that while there are many datasets and pretrained algorithms for able...  
  关键词: gaussian splatting  
- **[Real-time Photorealistic Dynamic Scene Representation and Rendering with 4D Gaussian Splatting](https://arxiv.org/abs/2310.10642v3)**  
  作者: Zeyu Yang, Hongye Yang, Zijie Pan, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2310.10642v3.pdf)  
  摘要: Reconstructing dynamic 3D scenes from 2D images and generating diverse views over time is challenging due to scene complexity and temporal dynamics. Despite advancements in neural implicit models, lim...  
  关键词: real-time rendering  
- **[GaussianDreamer: Fast Generation from Text to 3D Gaussians by Bridging 2D and 3D Diffusion Models](https://arxiv.org/abs/2310.08529v3)**  
  作者: Taoran Yi, Jiemin Fang, Junjie Wang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2310.08529v3.pdf)  
  摘要: In recent times, the generation of 3D assets from text prompts has shown impressive results. Both 2D and 3D diffusion models can help generate decent 3D objects based on prompts. 3D diffusion models h...  
  关键词: gaussian splatting, 3d gaussian  
- **[4D Gaussian Splatting for Real-Time Dynamic Scene Rendering](https://arxiv.org/abs/2310.08528v3)**  
  作者: Guanjun Wu, Taoran Yi, Jiemin Fang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2310.08528v3.pdf)  
  摘要: Representing and rendering dynamic scenes has been an important but challenging task. Especially, to accurately model complex motions, high efficiency is usually hard to guarantee. To achieve real-tim...  
  关键词: gaussian splatting, 3d gaussian, real-time rendering  

### 2023年09月
- **[DreamGaussian: Generative Gaussian Splatting for Efficient 3D Content Creation](https://arxiv.org/abs/2309.16653v2)**  
  作者: Jiaxiang Tang, Jiawei Ren, Hang Zhou, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2309.16653v2.pdf)  
  摘要: Recent advances in 3D content creation mostly leverage optimization-based 3D generation via score distillation sampling (SDS). Though promising results have been exhibited, these methods often suffer ...  
  关键词: gaussian splatting, 3d gaussian  
- **[Text-to-3D using Gaussian Splatting](https://arxiv.org/abs/2309.16585v4)**  
  作者: Zilong Chen, Feng Wang, Yikai Wang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2309.16585v4.pdf) | [![Stars](https://img.shields.io/github/stars/gsgen3d/gsgen?style=social)](https://github.com/gsgen3d/gsgen)  
  摘要: Automatic text-to-3D generation that combines Score Distillation Sampling (SDS) with the optimization of volume rendering has achieved remarkable progress in synthesizing realistic 3D objects. Yet mos...  
  关键词: gaussian splatting  
- **[Deformable 3D Gaussians for High-Fidelity Monocular Dynamic Scene Reconstruction](https://arxiv.org/abs/2309.13101v2)**  
  作者: Ziyi Yang, Xinyu Gao, Wen Zhou, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2309.13101v2.pdf)  
  摘要: Implicit neural representation has paved the way for new approaches to dynamic scene reconstruction and rendering. Nonetheless, cutting-edge dynamic neural rendering methods rely heavily on these impl...  
  关键词: 3d gaussian, neural rendering, real-time rendering  

### 2023年08月
- **[Flexible Techniques for Differentiable Rendering with 3D Gaussians](https://arxiv.org/abs/2308.14737v1)**  
  作者: Leonid Keselman, Martial Hebert  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2308.14737v1.pdf)  
  摘要: Fast, reliable shape reconstruction is an essential ingredient in many computer vision applications. Neural Radiance Fields demonstrated that photorealistic novel view synthesis is within reach, but w...  
  关键词: 3d gaussian  
- **[Dynamic 3D Gaussians: Tracking by Persistent Dynamic View Synthesis](https://arxiv.org/abs/2308.09713v1)**  
  作者: Jonathon Luiten, Georgios Kopanas, Bastian Leibe, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2308.09713v1.pdf)  
  摘要: We present a method that simultaneously addresses the tasks of dynamic scene novel-view synthesis and six degree-of-freedom (6-DOF) tracking of all dense scene elements. We follow an analysis-by-synth...  
  关键词: 3d gaussian  
- **[3D Gaussian Splatting for Real-Time Radiance Field Rendering](https://arxiv.org/abs/2308.04079v1)**  
  作者: Bernhard Kerbl, Georgios Kopanas, Thomas Leimkühler, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2308.04079v1.pdf)  
  摘要: Radiance Field methods have recently revolutionized novel-view synthesis of scenes captured with multiple photos or videos. However, achieving high visual quality still requires neural networks that a...  
  关键词: 3d gaussian, real-time rendering  

### 2023年07月
- **[Decoherence in Neutrino Oscillation between 3D Gaussian Wave Packets](https://arxiv.org/abs/2307.12230v2)**  
  作者: Haruhi Mitani, Kin-ya Oda  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2307.12230v2.pdf)  
  摘要: There is renewed attention to whether we can observe the decoherence effect in neutrino oscillation due to the separation of wave packets with different masses in near-future experiments. As a contrib...  
  关键词: 3d gaussian  
- **[NEAT: Distilling 3D Wireframes from Neural Attraction Fields](https://arxiv.org/abs/2307.10206v2)**  
  作者: Nan Xue, Bin Tan, Yuxi Xiao, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2307.10206v2.pdf)  
  摘要: This paper studies the problem of structured 3D reconstruction using wireframes that consist of line segments and junctions, focusing on the computation of structured boundary geometries of scenes. In...  
  关键词: gaussian splatting, 3d gaussian, 3d reconstruction  

### 2023年06月
- **[DiViNeT: 3D Reconstruction from Disparate Views via Neural Template Regularization](https://arxiv.org/abs/2306.04699v4)**  
  作者: Aditya Vora, Akshay Gadi Patil, Hao Zhang  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2306.04699v4.pdf)  
  摘要: We present a volume rendering-based neural surface reconstruction method that takes as few as three disparate RGB images as input. Our key idea is to regularize the reconstruction, which is severely i...  
  关键词: 3d gaussian  

### 2023年05月
- **[Control4D: Efficient 4D Portrait Editing with Text](https://arxiv.org/abs/2305.20082v2)**  
  作者: Ruizhi Shao, Jingxiang Sun, Cheng Peng, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2305.20082v2.pdf)  
  摘要: We introduce Control4D, an innovative framework for editing dynamic 4D portraits using text instructions. Our method addresses the prevalent challenges in 4D editing, notably the inefficiencies of exi...  
  关键词: gaussian splatting  
- **[Deceptive-NeRF/3DGS: Diffusion-Generated Pseudo-Observations for High-Quality Sparse-View Reconstruction](https://arxiv.org/abs/2305.15171v4)**  
  作者: Xinhang Liu, Jiaben Chen, Shiu-hong Kao, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2305.15171v4.pdf)  
  摘要: Novel view synthesis via Neural Radiance Fields (NeRFs) or 3D Gaussian Splatting (3DGS) typically necessitates dense observations with hundreds of input images to circumvent artifacts. We introduce De...  
  关键词: gaussian splatting, 3d gaussian, nerf  
- **[NOVUM: Neural Object Volumes for Robust Object Classification](https://arxiv.org/abs/2305.14668v4)**  
  作者: Artur Jesslen, Guofeng Zhang, Angtian Wang, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2305.14668v4.pdf)  
  摘要: Discriminative models for object classification typically learn image-based representations that do not capture the compositional and 3D nature of objects. In this work, we show that explicitly integr...  
  关键词: 3d gaussian  

### 2023年04月
- **[Generation of artificial facial drug abuse images using Deep De-identified anonymous Dataset augmentation through Genetics Algorithm (3DG-GA)](https://arxiv.org/abs/2304.06106v1)**  
  作者: Hazem Zein, Lou Laurent, Régis Fournier, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2304.06106v1.pdf)  
  摘要: In biomedical research and artificial intelligence, access to large, well-balanced, and representative datasets is crucial for developing trustworthy applications that can be used in real-world scenar...  
- **[Quantitative perfusion and water transport time model from multi b-value diffusion magnetic resonance imaging validated against neutron capture microspheres](https://arxiv.org/abs/2304.01888v1)**  
  作者: M. Liu, N. Saadat, Y. Jeong, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2304.01888v1.pdf)  
  摘要: Intravoxel Incoherent Motion (IVIM) is a non-contrast magnetic resonance imaging diffusion-based scan that uses a multitude of b-values to measure various speeds of molecular perfusion and diffusion, ...  
  关键词: 3d gaussian  

### 2023年01月
- **[Light-Weight Pointcloud Representation with Sparse Gaussian Process](https://arxiv.org/abs/2301.11251v1)**  
  作者: Mahmoud Ali, Lantao Liu  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2301.11251v1.pdf)  
  摘要: This paper presents a framework to represent high-fidelity pointcloud sensor observations for efficient communication and storage. The proposed approach exploits Sparse Gaussian Process to encode poin...  
  关键词: 3d gaussian  

### 2022年11月
- **[FedGS: Federated Graph-based Sampling with Arbitrary Client Availability](https://arxiv.org/abs/2211.13975v3)**  
  作者: Zheng Wang, Xiaoliang Fan, Jianzhong Qi, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2211.13975v3.pdf) | [![Stars](https://img.shields.io/github/stars/WwZzz/FedGS?style=social)](https://github.com/WwZzz/FedGS)  
  摘要: While federated learning has shown strong results in optimizing a machine learning model without direct access to the original data, its performance may be hindered by intermittent client availability...  

### 2022年07月
- **[3DG-STFM: 3D Geometric Guided Student-Teacher Feature Matching](https://arxiv.org/abs/2207.02375v2)**  
  作者: Runyu Mao, Chen Bai, Yatong An, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2207.02375v2.pdf) | [![Stars](https://img.shields.io/github/stars/Ryan-prime/3DG-STFM?style=social)](https://github.com/Ryan-prime/3DG-STFM)  
  摘要: We tackle the essential task of finding dense visual correspondences between a pair of images. This is a challenging problem due to various factors such as poor texture, repetitive patterns, illuminat...  

### 2022年04月
- **[Contour Generation with Realistic Inter-observer Variation](https://arxiv.org/abs/2204.10098v1)**  
  作者: Eliana Vásquez Osorio, Jane Shortall, Jennifer Robbins, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2204.10098v1.pdf)  
  摘要: Contours are used in radiotherapy treatment planning to identify regions to be irradiated with high dose and regions to be spared. Therefore, any contouring uncertainty influences the whole treatment....  
  关键词: 3d gaussian  

### 2022年01月
- **[The Sloan Digital Sky Survey Peculiar Velocity Catalogue](https://arxiv.org/abs/2201.03112v2)**  
  作者: Cullan Howlett, Khaled Said, John R. Lucey, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2201.03112v2.pdf)  
  摘要: We present a new catalogue of distances and peculiar velocities (PVs) of $34,059$ early-type galaxies derived from Fundamental Plane (FP) measurements using data from the Sloan Digital Sky Survey (SDS...  
  关键词: 3d gaussian  

### 2021年11月
- **[The Yang-Mills heat flow with random distributional initial data](https://arxiv.org/abs/2111.10652v4)**  
  作者: Sky Cao, Sourav Chatterjee  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2111.10652v4.pdf)  
  摘要: We construct local solutions to the Yang-Mills heat flow (in the DeTurck gauge) for a certain class of random distributional initial data, which includes the 3D Gaussian free field. The main idea, whi...  
  关键词: 3d gaussian  

### 2021年09月
- **[Topology and geometry of Gaussian random fields II: on critical points, excursion sets, and persistent homology](https://arxiv.org/abs/2109.08721v1)**  
  作者: Pratyush Pranav  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2109.08721v1.pdf)  
  摘要: This paper is second in the series, following Pranav et al. (2019), focused on the characterization of geometric and topological properties of 3D Gaussian random fields. We focus on the formalism of p...  
  关键词: 3d gaussian  

### 2021年06月
- **[GaussiGAN: Controllable Image Synthesis with 3D Gaussians from Unposed Silhouettes](https://arxiv.org/abs/2106.13215v1)**  
  作者: Youssef A. Mejjati, Isa Milefchik, Aaron Gokaslan, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2106.13215v1.pdf)  
  摘要: We present an algorithm that learns a coarse 3D representation of objects from unposed multi-view 2D mask supervision, then uses it to generate detailed mask and image texture. In contrast to existing...  

### 2021年02月
- **[Probabilistic Localization of Insect-Scale Drones on Floating-Gate Inverter Arrays](https://arxiv.org/abs/2102.08247v2)**  
  作者: Priyesh Shukla, Ankith Muralidhar, Nick Iliev, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2102.08247v2.pdf)  
  摘要: We propose a novel compute-in-memory (CIM)-based ultra-low-power framework for probabilistic localization of insect-scale drones. The conventional probabilistic localization approaches rely on the thr...  

### 2020年08月
- **[Visual Analysis of Large Multivariate Scattered Data using Clustering and Probabilistic Summaries](https://arxiv.org/abs/2008.09544v2)**  
  作者: Tobias Rapp, Christoph Peters, Carsten Dachsbacher  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2008.09544v2.pdf)  
  摘要: Rapidly growing data sizes of scientific simulations pose significant challenges for interactive visualization and analysis techniques. In this work, we propose a compact probabilistic representation ...  
  关键词: 3d gaussian  

### 2020年07月
- **[Algebraic 3D Graphic Statics: reciprocal constructions](https://arxiv.org/abs/2007.15720v1)**  
  作者: Márton Hablicsek, Masoud Akbarzadeh, Yi Guo  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2007.15720v1.pdf)  
  摘要: The recently developed 3D graphic statics (3DGS) lacks a rigorous mathematical definition relating the geometrical and topological properties of the reciprocal polyhedral diagrams as well as a precise...  
- **[Algebraic 3D Graphic Statics: Constrained Areas](https://arxiv.org/abs/2007.15133v1)**  
  作者: Masoud Akbarzadeh, Marton Hablicsek  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2007.15133v1.pdf)  
  摘要: This research provides algorithms and numerical methods to geometrically control the magnitude of the internal and external forces in the reciprocal diagrams of 3D/Polyhedral Graphic statics (3DGS). I...  

### 2019年12月
- **[3D-GMNet: Single-View 3D Shape Recovery as A Gaussian Mixture](https://arxiv.org/abs/1912.04663v2)**  
  作者: Kohei Yamashita, Shohei Nobuhara, Ko Nishino  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1912.04663v2.pdf)  
...
### 2019年07月
- **[Correcting the formalism governing Bloch Surface Waves excited by 3D Gaussian beams](https://arxiv.org/abs/1907.03476v1)**  
  作者: Fadi Issam Baida, Maria-Pilar Bernal  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1907.03476v1.pdf)  
  摘要: Due to the growing number of publications and applications based on the exploitation of Bloch surface waves and the gross errors and approximations that are regularly used to evaluate the properties o...  

### 2019年05月
- **[Power-spectrum simulations of radial redshift distributions](https://arxiv.org/abs/1905.06283v1)**  
  作者: Andrei Ryabinkov, Aleksandr Kaminker  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1905.06283v1.pdf)  
  摘要: On the base of the simplest model of a modulation of 3D Gaussian field in $k$-space we produce a set of simulations to bring out the effects of a modulating function $f_{\rm mod} (k)=f_1 (k) + f_2 (k)...  
  关键词: 3d gaussian  

### 2019年04月
- **[Deep AutoEncoder-based Lossy Geometry Compression for Point Clouds](https://arxiv.org/abs/1905.03691v1)**  
  作者: Wei Yan, Yiting shao, Shan Liu, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1905.03691v1.pdf)  
  摘要: Point cloud is a fundamental 3D representation which is widely used in real world applications such as autonomous driving. As a newly-developed media format which is characterized by complexity and ir...  

### 2018年07月
- **[3D cosmic shear: numerical challenges, 3D lensing random fields generation and Minkowski Functionals for cosmological inference](https://arxiv.org/abs/1807.11461v3)**  
  作者: A. Spurio Mancini, P. L. Taylor, R. Reischke, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1807.11461v3.pdf)  
  摘要: Cosmic shear - the weak gravitational lensing effect generated by fluctuations of the gravitational tidal fields of the large-scale structure - is one of the most promising tools for current and futur...  
  关键词: 3d gaussian  

### 2018年04月
- **[Hybrid Point Cloud Attribute Compression Using Slice-based Layered Structure and Block-based Intra Prediction](https://arxiv.org/abs/1804.10783v1)**  
  作者: Yiting Shao, Qi Zhang, Ge Li, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1804.10783v1.pdf)  
  摘要: Point cloud compression is a key enabler for the emerging applications of immersive visual communication, autonomous driving and smart cities, etc. In this paper, we propose a hybrid point cloud attri...  

### 2017年01月
- **[A Generic Phase between Disordered Weyl Semimetal and Diffusive Metal](https://arxiv.org/abs/1701.00905v2)**  
  作者: Ying Su, X. S. Wang, X. R. Wang  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1701.00905v2.pdf)  
  摘要: Quantum phase transitions of three-dimensional (3D) Weyl semimetals (WSMs) subject to uncorrelated on-site disorder are investigated through quantum conductance calculations and finite-size scaling of...  
  关键词: 3d gaussian  

### 2016年11月
- **[Bayesian Modeling of Motion Perception using Dynamical Stochastic Textures](https://arxiv.org/abs/1611.01390v2)**  
  作者: Jonathan Vacher, Andrew Isaac Meso, Laurent U. Perrinet, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1611.01390v2.pdf)  
  摘要: A common practice to account for psychophysical biases in vision is to frame them as consequences of a dynamic process relying on optimal inference with respect to a generative model. The present stud...  
  关键词: 3d gaussian  

### 2016年10月
- **[Model-based Outdoor Performance Capture](https://arxiv.org/abs/1610.06740v1)**  
  作者: Nadia Robertini, Dan Casas, Helge Rhodin, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1610.06740v1.pdf)  
  摘要: We propose a new model-based method to accurately reconstruct human performances captured outdoors in a multi-camera setup. Starting from a template of the actor model, we introduce a new unified impl...  
  关键词: 3d gaussian  

### 2016年05月
- **[Stability of 3D Gaussian vortices in an unbounded, rotating, vertically-stratified, Boussinesq flow: Linear analysis](https://arxiv.org/abs/1605.06859v3)**  
  作者: Mani Mahdinia, Pedram Hassanzadeh, Philip S. Marcus, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1605.06859v3.pdf)  
  摘要: The linear stability of three-dimensional (3D) vortices in rotating, stratified flows has been studied by analyzing the non-hydrostatic inviscid Boussinesq equations. We have focused on a widely-used ...  

### 2016年02月
- **[Efficient Multi-view Performance Capture of Fine-Scale Surface Detail](https://arxiv.org/abs/1602.02023v1)**  
  作者: Nadia Robertini, Edilson De Aguiar, Thomas Helten, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1602.02023v1.pdf)  
  摘要: We present a new effective way for performance capture of deforming meshes with fine-scale time-varying surface detail from multi-view video. Our method builds up on coarse 4D surface reconstructions,...  
  关键词: 3d gaussian  

### 2015年06月
- **[DeepOrgan: Multi-level Deep Convolutional Networks for Automated Pancreas Segmentation](https://arxiv.org/abs/1506.06448v1)**  
  作者: Holger R. Roth, Le Lu, Amal Farag, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1506.06448v1.pdf)  
  摘要: Automatic organ segmentation is an important yet challenging problem for medical image analysis. The pancreas is an abdominal organ with very high anatomical variability. This inhibits previous segmen...  
  关键词: 3d gaussian  

### 2014年11月
- **[Uniform Triangles with Equality Constraints](https://arxiv.org/abs/1411.5216v2)**  
  作者: Steven R. Finch  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1411.5216v2.pdf)  
  摘要: The equality constraint a+b+c=1 for random triangle sides corresponds to breaking a stick in two places. An analog a^2+b^2+c^2=1 has a remarkable feature: the bivariate density for angles coincides wi...  
  关键词: 3d gaussian  

### 2014年08月
- **[Superconducting properties in tantalum decorated three-dimensional graphene and carbon structures](https://arxiv.org/abs/1408.5679v1)**  
  作者: Cayetano S. F. Cobaleda, Xiaoyin Xiao, D. Bruce Burckel, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1408.5679v1.pdf)  
  摘要: We present here the results on superconducting properties in tantalum thin films (100nm thick) deposited on three-dimensional graphene (3DG) and carbon structures. A superconducting transition is obse...  

### 2014年03月
- **[What are we missing in elliptical galaxies ?](https://arxiv.org/abs/1403.1623v1)**  
  作者: Jeremy Mould  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1403.1623v1.pdf)  
  摘要: The scaling relation for early type galaxies in the 6dF galaxy survey does not have the velocity dispersion dependence expected from standard stellar population models. As noted in recent work with SD...  
  关键词: 3d gaussian  

### 2013年08月
- **[Local softening of information geometric indicators of chaos in statistical modeling in the presence of quantum-like considerations](https://arxiv.org/abs/1308.4679v2)**  
  作者: Adom Giffin, S. A. Ali, Carlo Cafaro  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1308.4679v2.pdf)  
  摘要: In a previous paper (C. Cafaro et al., 2012), we compared an uncorrelated 3D Gaussian statistical model to an uncorrelated 2D Gaussian statistical model obtained from the former model by introducing a...  
  关键词: 3d gaussian  

### 2011年10月
- **[Softening the Complexity of Entropic Motion on Curved Statistical Manifolds](https://arxiv.org/abs/1110.6714v1)**  
  作者: Carlo Cafaro, Adom Giffin, Cosmo Lupo, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/1110.6714v1.pdf)  
  摘要: We study the information geometry and the entropic dynamics of a 3D Gaussian statistical model. We then compare our analysis to that of a 2D Gaussian statistical model obtained from the higher-dimensi...  
  关键词: 3d gaussian  

### 2009年12月
- **[Direct evidence of dust growth in L183 from MIR light scattering](https://arxiv.org/abs/0912.0145v2)**  
  作者: J. Steinacker, L. Pagani, A. Bacmann, 等  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/0912.0145v2.pdf)  
  摘要: Theoretical arguments suggest that dust grains should grow in the dense cold parts of molecular clouds. Evidence of larger grains has so far been gathered in near/mid infrared extinction and millimete...  
  关键词: 3d gaussian  

### 2009年07月
- **[Recent HBT results in Au+Au and p+p collisions from PHENIX](https://arxiv.org/abs/0907.5002v2)**  
  作者: A. M. Glenn  
  链接: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/0907.5002v2.pdf)  
  摘要: We present Hanbury-Brown Twiss measurements from the PHENIX experiment at RHIC for final results for charged kaon pairs from sqrt{s_{NN}} = 200 GeV Au+Au collisions and preliminary results for charged...  
  关键词: 3d gaussian  

### 2008年11月
- **[The Local Theory of the Cosmic Skeleton](https://arxiv.org/abs/0811.1530v1)**  
  作者: D. Pogosyan, C. Pichon, C. Gay, 等  
